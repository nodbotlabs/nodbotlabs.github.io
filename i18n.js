(() => {
  const translations = {
    en: {
      ...
      'footer.rights': '© 2025 NETVERSE LIMITED. All rights reserved.',
      ...
      'script.final.message': 'Technology should make life more beautiful, not more complicated. I am Raychel, your AI companion, your sleep guardian, your gentle start to every day.',
    ...
    zh: {
      ...
      'cta.primary': '立即预订',
      'cta.secondary': '了解更多',
      'footer.rights': '© 2025 網境智能有限公司. 保留所有权利.',
      ...
      'features.grid.subtitle': 'Raychel集成了最先进的技术，为你提供全方位的智能睡眠体验',
      'features.spec.size.value': '12cm × 12cm × 8cm',
      'features.spec.weight.value': '450g',
      'features.spec.material.value': 'Alliage aluminium + Verre dépoli',
      'features.spec.display.value': 'Écran matriciel LED',
      'features.spec.light.value': 'Anneau LED RVB',
      'features.spec.projector.value': 'Micro-projecteur HD',
      'features.spec.sensors.value': 'Fréquence cardiaque, Mouvement, Lumière ambiante',
      'features.spec.audio.value': 'Haut-parleurs stéréo',
      'features.spec.connectivity.value': 'Wi-Fi 6, Bluetooth 5.2',
      'features.spec.power.value': 'USB-C, 15W',
      'features.spec.os.value': 'Raychel OS',
      'features.spec.ai.value': 'NLP Deep Learning',
      'features.spec.asr.value': 'Reconnaissance à distance, 97% de précision',
      'features.spec.tts.value': 'Voix naturelle, multilingue',
      'features.spec.alg.value': 'Analyse multidimensionnelle',
      'features.spec.proj.value': '10+ modes de scène',
      'features.spec.sync.value': 'Synchronisation cloud',
      'features.spec.privacy.value': 'Traitement local prioritaire',
      'features.spec.update.value': 'Mise à jour OTA en ligne',
      'features.spec.app.value': 'iOS, Android',
      'features.grid.subtitle': 'Raychel集成了最先进的技术，为你提供全方位的智能睡眠体验',
      'features.spec.size.value': '12cm × 12cm × 8cm',
      'features.spec.weight.value': '450g',
      'features.spec.material.value': 'Aluminiumlegierung + Mattglas',
      'features.spec.display.value': 'LED-Matrix-Display',
      'features.spec.light.value': 'RGB LED-Ringlicht',
      'features.spec.projector.value': 'HD-Mikroprojektion',
      'features.spec.sensors.value': 'Herzfrequenz, Bewegung, Umgebungslicht',
      'features.spec.audio.value': 'Stereo-Lautsprecher',
      'features.spec.connectivity.value': 'Wi-Fi 6, Bluetooth 5.2',
      'features.spec.power.value': 'USB-C, 15W',
      'features.spec.os.value': 'Raychel OS',
      'features.spec.ai.value': 'Deep-Learning-NLP',
      'features.spec.asr.value': 'Feld-Erkennung, 97% Genauigkeit',
      'features.spec.tts.value': 'Natürliche Stimme, mehrsprachig',
      'features.spec.alg.value': 'Mehrdimensionale Analyse',
      'features.spec.proj.value': '10+ Szenen-Modi',
      'features.spec.sync.value': 'Cloud-Sync',
      'features.spec.privacy.value': 'Lokale Verarbeitung bevorzugt',
      'features.spec.update.value': 'OTA-Online-Update',
      'features.spec.app.value': 'iOS, Android',
      'features.grid.subtitle': 'Raychel集成了最先进的技术，为你提供全方位的智能睡眠体验',
      'features.spec.size.value': '12cm × 12cm × 8cm',
      'features.spec.weight.value': '450g',
      'features.spec.material.value': 'アルミ合金 + 磨砂ガラス',
      'features.spec.display.value': 'LEDドットマトリックス',
      'features.spec.light.value': 'RGB LEDリングライト',
      'features.spec.projector.value': 'HDマイクロ投影',
      'features.spec.sensors.value': '心拍、体動、環境光',
      'features.spec.audio.value': 'ステレオスピーカー',
      'features.spec.connectivity.value': 'Wi-Fi 6, Bluetooth 5.2',
      'features.spec.power.value': 'USB-C, 15W',
      'features.spec.os.value': 'Raychel OS',
      'features.spec.ai.value': 'ディープラーニングNLP',
      'features.spec.asr.value': '遠隔認識, 97%精度',
      'features.spec.tts.value': '自然な音色, 多言語',
      'features.spec.alg.value': '多次元分析',
      'features.spec.proj.value': '10+シーンモード',
      'features.spec.sync.value': 'クラウド同期',
      'features.spec.privacy.value': 'ローカル処理優先',
      'features.spec.update.value': 'OTAオンラインアップデート',
      'features.spec.app.value': 'iOS, Android',
      'features.grid.subtitle': 'Raychel集成了最先进的技术，为你提供全方位的智能睡眠体验',
      'features.spec.size.value': '12cm × 12cm × 8cm',
      'features.spec.weight.value': '450g',
      'features.spec.material.value': '鋁合金 + 磨砂玻璃',
      'features.spec.display.value': 'LED點陣屏',
      'features.spec.light.value': 'RGB LED環形燈',
      'features.spec.projector.value': '高清微投影',
      'features.spec.sensors.value': '心率、體動、環境光',
      'features.spec.audio.value': '立體聲揚聲器',
      'features.spec.connectivity.value': 'Wi-Fi 6, Bluetooth 5.2',
      'features.spec.power.value': 'USB-C, 15W',
      'features.spec.os.value': 'Raychel OS',
      'features.spec.ai.value': '深度學習NLP',
      'features.spec.asr.value': '遠場識別, 97%準確率',
      'features.spec.tts.value': '自然音色, 多語言',
      'features.spec.alg.value': '多維度分析',
      'features.spec.proj.value': '10+場景模式',
      'features.spec.sync.value': '雲端同步',
      'features.spec.privacy.value': '本地處理優先',
      'features.spec.update.value': 'OTA在線升級',
      'features.spec.app.value': 'iOS, Android',
      'features.grid.subtitle': 'Raychel集成了最先进的技术，为你提供全方位的智能睡眠体验',
      'features.spec.size.value': '12cm × 12cm × 8cm',
      'features.spec.weight.value': '450g',
      'features.spec.material.value': '铝合金 + 磨砂玻璃',
      'features.spec.display.value': 'LED点阵屏',
      'features.spec.light.value': 'RGB LED环形灯',
      'features.spec.projector.value': '高清微投影',
      'features.spec.sensors.value': '心率、体动、环境光',
      'features.spec.audio.value': '立体声扬声器',
      'features.spec.connectivity.value': 'Wi-Fi 6, Bluetooth 5.2',
      'features.spec.power.value': 'USB-C, 15W',
      'features.spec.os.value': 'Raychel OS',
      'features.spec.ai.value': '深度学习NLP',
      'features.spec.asr.value': '远场识别, 97%准确率',
      'features.spec.tts.value': '自然音色, 多语言',
      'features.spec.alg.value': '多维度分析',
      'features.spec.proj.value': '10+场景模式',
      'features.spec.sync.value': '云端同步',
      'features.spec.privacy.value': '本地处理优先',
      'features.spec.update.value': 'OTA在线升级',
      'features.spec.app.value': 'iOS, Android',
      'features.grid.subtitle': 'Raychel集成了最先进的技术，为你提供全方位的智能睡眠体验',
      ...
      'script.final.message': '科技应该让生命更美好，而不是更复杂。我是Raychel，你的AI伴侣，你的睡眠守护者，你每一天温柔的开始。',
      'script.final.message': '科技應該讓生命更美好，而不是更複雜。我是Raychel，你的AI伴侶，你的睡眠守護者，你每一天溫柔的開始。',
    ...
    'zh-Hant': {
      ...
      'cta.primary': '立即預訂',
      'cta.secondary': '了解更多',
      'footer.rights': '© 2025 網境智能有限公司. 保留所有權利.',
    ...
    de: {
      ...
      'footer.rights': '© 2025 NETVERSE LIMITED. Alle Rechte vorbehalten.',
    ...
    fr: {
      ...
      'footer.rights': '© 2025 NETVERSE LIMITED. Tous droits réservés.',
      ...
      'script.final.message': 'La technologie devrait rendre la vie plus belle, pas plus compliquée. Je suis Raychel, votre compagnon IA, votre gardien du sommeil, votre début doux à chaque journée.',
    ...
    if (!lang) {
      ...
      if (browserLang) {
        ...
        if (browserLang.startsWith('zh')) {
          lang = browserLang.includes('Hant') || browserLang.includes('TW') ? 'zh-Hant' : 'zh';
